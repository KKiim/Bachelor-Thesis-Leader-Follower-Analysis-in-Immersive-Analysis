...
* Host this directory on a server.
  ...
  * Master Display: localhost:8080/Apps/Sandcastle/gallery/1PythonLF.html?mode=m
  * Slave Displays: localhost:8080/Apps/Sandcastle/gallery/1PythonLF.html?mode=s
OR

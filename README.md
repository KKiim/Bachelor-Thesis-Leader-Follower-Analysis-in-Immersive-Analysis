...
Open [http://localhost:<port>/Apps/Sandcastle/gallery/1SyncBird.html](http://localhost:<port>/Apps/Sandcastle/gallery/1SyncBird.html) in your Browser(Chrome or Firefox).
